            ...
            <tr key={index}>
              ...
              >
                ...
                <div style={{ marginBottom: 10 }}>
                  <StarComponent rating={product.rate} />
                </div>
                <text style={{ marginBottom: 12, color: "gray" }}>
                  ({product.reviews})
                </text>
              </td>
              <td style={{...styles.thTdTable,paddingLeft:60}}>{product.quantity}</td>
